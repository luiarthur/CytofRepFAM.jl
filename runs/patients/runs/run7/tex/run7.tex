...
% "CD25", "CD2 7", "CD57", "CD62L", "CD8", "CD94", "CKIT", "DNAM1", "EOMES",
% "GRA", "GRB", "KLRG1", "LFA1", "NKG2A", "NKG2C", "NKG2D", "NKP30", "PERFORIN",
% "SIGLEC7", "SYK", "TBET", "TIGIT" , "TRAIL", "ZAP70"]
% Good markers: ["2B4", "2DL3", "3DL1", "CD158B", "CD16", "CD57", "CD62L", "CD8",
% "CD94", "CKIT", "DNAM1", "EOMES", "GRA", "GRB", "NKG2A", "NKG2D", "NKP30",
% "PERFORIN", "SIGLEC7", "SYK", "TBET", "TIGIT", "ZAP70"]
% Bad markers: ["2DL1", "2DS4", "CCR7", "CD25", "CD27", "KLRG1", "LFA1", "NKG2C", "TRAIL"]
\begin{table}[H]
  \begin{center}
...
\begin{figure}[H]
  ...
  made when proposed between the various chains for each setup. A noticeable amount of Swapping occurred between the chains. The colorbars on the right of each
