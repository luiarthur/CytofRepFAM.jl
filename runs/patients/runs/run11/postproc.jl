...
if length(ARGS) == 0
  results_dir = "/scratchdata/alui2/cytof/results/repfam/patients-data/run11/"
else
...
@everywhere function plot_params(samples, dfs, imgdir)
...
@everywhere function makeplots(path_to_output)
  ...
  # Plot parameters
  plot_params(samples, output[:d], imgdir)
