...
\begin{figure}[H]
  ...
  \begin{tabular}{cc}
    (a) FlowSOM sample 1 &
    (b) FlowSOM sample 2 \\
    \includegraphics[scale=0.3]{\imgdir/flowsom-tsne-combined-1.pdf} &
    \includegraphics[scale=0.3]{\imgdir/flowsom-tsne-combined-2.pdf} \\
    (d) Mclust sample 1 &
    (e) Mclust sample 2 \\
    \includegraphics[scale=0.3]{\imgdir/mclust-tsne-combined-1.pdf} &
    \includegraphics[scale=0.3]{\imgdir/mclust-tsne-combined-2.pdf} \\
    (g) FAM $\phi=0$ sample 1 &
    (h) FAM $\phi=0$ sample 2 \\
    \includegraphics[scale=0.3]{\imgdir/fam-phi0-tsne-combined-1.pdf} &
    \includegraphics[scale=0.3]{\imgdir/fam-phi0-tsne-combined-2.pdf} \\
    (j) FAM $\phi=100$ sample 1 &
    (k) FAM $\phi=100$ sample 2 \\
    \includegraphics[scale=0.3]{\imgdir/fam-phi100-tsne-combined-1.pdf} &
    \includegraphics[scale=0.3]{\imgdir/fam-phi100-tsne-combined-2.pdf} \\
  \end{tabular}
