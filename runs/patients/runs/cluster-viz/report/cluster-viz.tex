...
\begin{figure}[H]
  ...
  \begin{tabular}{ccc}
    ...
    (b) FlowSOM sample 2 &
    (c) FlowSOM sample 3 \\
    \includegraphics[scale=0.25]{\imgdir/flowsom-tsne-combined-1.pdf} &
    \includegraphics[scale=0.25]{\imgdir/flowsom-tsne-combined-2.pdf} &
    \includegraphics[scale=0.25]{\imgdir/flowsom-tsne-combined-3.pdf} \\
    (d) Mclust sample 1 &
    (e) Mclust sample 2 &
    (f) Mclust sample 3 \\
    \includegraphics[scale=0.25]{\imgdir/mclust-tsne-combined-1.pdf} &
    \includegraphics[scale=0.25]{\imgdir/mclust-tsne-combined-2.pdf} &
    \includegraphics[scale=0.25]{\imgdir/mclust-tsne-combined-3.pdf} \\
    (g) FAM $\phi=0$ sample 1 &
    (h) FAM $\phi=0$ sample 2 &
    (i) FAM $\phi=0$ sample 3 \\
    \includegraphics[scale=0.25]{\imgdir/fam-phi0-tsne-combined-1.pdf} &
    \includegraphics[scale=0.25]{\imgdir/fam-phi0-tsne-combined-2.pdf} &
    \includegraphics[scale=0.25]{\imgdir/fam-phi0-tsne-combined-3.pdf} \\
    (j) FAM $\phi=1$ sample 1 &
    (k) FAM $\phi=1$ sample 2 &
    (l) FAM $\phi=1$ sample 3 \\
    \includegraphics[scale=0.25]{\imgdir/fam-phi1-tsne-combined-1.pdf} &
    \includegraphics[scale=0.25]{\imgdir/fam-phi1-tsne-combined-2.pdf} &
    \includegraphics[scale=0.25]{\imgdir/fam-phi1-tsne-combined-3.pdf} \\
  \end{tabular}
