...
\newcommand{\imgtemplate}[2]{
  \begin{tabular}{cc}
    ...
    (c) Mclust, Sample 1, Complete &
    (d) Mclust, Sample 2, Complete \\
    ...
    \hline \\
    (e) FlowSOM, Sample 1, Imputed &
    (f) FlowSOM, Sample 2, Imputed \\
    ...
    (g) Mclust, Sample 1, Imputed &
    (h) Mclust, Sample 2, Imputed \\
