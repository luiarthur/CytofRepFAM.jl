...
\newcommand{\imgtemplate}[2]{
  \begin{tabular}{ccccc}
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.0-phi0.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.0-phi0.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.6-phi0.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.6-phi0.0-zind#2.pdf} \\
    {\tiny (m) rFAM, Sample 1, Complete} &
    {\tiny (n) rFAM, Sample 2, Complete} &
    {\tiny (o) rFAM, Sample 1, Missing} &
    {\tiny (p) rFAM, Sample 2, Missing} \\
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.0-phi100.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.0-phi100.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.6-phi100.0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.6-phi100.0-zind#2.pdf} \\
