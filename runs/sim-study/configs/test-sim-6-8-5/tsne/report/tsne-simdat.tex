...
\newcommand{\imgtemplate}[2]{
  \begin{tabular}{ccccc}
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.0-phi1-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.0-phi1-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.6-phi1-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.6-phi1-zind#2.pdf} \\
