...
\newcommand{\imgtemplate}[2]{
  \begin{tabular}{ccccc}
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-flowsom1-pmiss0.2-phi0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-flowsom2-pmiss0.2-phi0-zind#2.pdf} \\
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-mclust1-pmiss0.2-phi0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-mclust2-pmiss0.2-phi0-zind#2.pdf} \\
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.2-phi0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.2-phi0-zind#2.pdf} \\
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-rfam1-pmiss0.2-phi100-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-rfam2-pmiss0.2-phi100-zind#2.pdf} \\
    ...
    \includegraphics[scale=#1]{\imgdir/tsne-true_labels1-pmiss0.2-phi0-zind#2.pdf} &
    \includegraphics[scale=#1]{\imgdir/tsne-true_labels2-pmiss0.2-phi0-zind#2.pdf} \\
  \end{tabular}
}
