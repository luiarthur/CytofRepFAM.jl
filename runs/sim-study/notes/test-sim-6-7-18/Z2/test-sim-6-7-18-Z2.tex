...
\begin{figure}[H]
  ...
  recovered features is 4 to 6. The features most commonly missing are features
  1 and 7, which are also the least abundant. For Data 3, when $\phi=0$, 
  feature 2 (the next least abundant feature) was also missing at times.
  For $\phi>0$, all features were recovered in every run. This suggests
  that when features are distinct, the r-FAM is more likely to recover
  all features, even if some are only weakly present in one sample.}
  \label{fig:zmean}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{Duplicated features appear in $\hat Z_1$.}
  \label{fig:z1est}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{Duplicated features appear in $\hat Z_2$.}
  \label{fig:z2est}
\end{figure}
