...
\begin{figure}[H]
  ...
  1, 2 and 7, which are also the least abundant. In addition, features 1 and 2 are 
  similar to feature 3, which is abundant. When $\phi>0$, in many cases,
  all seven features were recovered. At times only 6 was recovered. The feature
  that was missing in those cases was feature 1 or 2.}
  \label{fig:zmean}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{When $\phi=0$, duplicate features occur, especially for the
