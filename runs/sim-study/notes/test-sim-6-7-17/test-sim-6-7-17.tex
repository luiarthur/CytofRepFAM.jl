...
\def\imgdir{../../results/test-sim-6-7-17}
\input{imgtemplate.tex}

% Title Settings
\title{Simulation Study 6.7.17}
\author{Arthur Lui}
...
\begin{itemize}
  \item Model was fit to complete data (no missing data). 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Log likelihoods after burn in. More burn-in is needed.}
  \label{fig:ll}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{Posterior means of $Z$. The simulation truth for $Z$ is recovered
  in a few of the runs. Each run recovers 6 or 7 features. The features that
  are missing are either Feature 1 or Feature 2 from the simulation truth.
  These are features that are rare, but similar to other more abundant
  features.}
  \label{fig:zmean}
\end{figure}
