...
$Z$ and $W$ used to generate the simulated data in this study. Notice that 
\begin{itemize}
...
\begin{figure}[H]
  \begin{center}  % 6 x 5
    \includegraphics[scale=.3]{\imgdir/dataseed_1/mcmcseed_1/scale_0/img/Z_true.pdf}
  \end{center}
  \caption{$Z^\true$}
  \label{fig:Z-true}
\end{figure}
...
\begin{table}[ht]
  ...
  \begin{tabular}{rrrrrrrr}
    ...
    \hline
    1 & 0.04 & 0.05 & 0.39 & 0.00 & 0.06 & 0.43 & 0.03 \\
    2 & 0.00 & 0.05 & 0.54 & 0.20 & 0.14 & 0.07 & 0.00 \\
    \hline
  \end{tabular}
  \caption{$W^\true$}
  \label{tab:W-true}
