...
\def\imgdir{../../results/test-sim-6-7-16}
\input{imgtemplate.tex}

% Title Settings
\title{Simulation Study 6.7.16}
\author{Arthur Lui}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item 5\% of data in each sample are used to sample from trained prior, and
      $M=5$ was used.
    \item Data simulated with no missing data.
  \end{itemize}
\end{itemize}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Log-likelihoods for each simulation setup. Burn-in is insufficient.
  Perhaps something more realistic is 6000.}
  \label{fig:ll}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{Runs (e), (g), and (i) recover the simulation truth, though the
  chains are still transitioning.}
  \label{fig:zmean}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{None of the $\mu^\star_0$'s are near 0. Both $\mu_0$ and $\mu_1$ is
  near their true values. The deviance is due to the data being simulated with 
  some perturbation in the $\mu$.}
  \label{fig:mus-trace}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  % TODO: Write more?
  \caption{The $\sigma^2_i$ are near their true values. The deviance is due to
  the data being simulated with some perturbation in the $\mu$.}
