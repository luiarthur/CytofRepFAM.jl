...
\begin{itemize}
  ...
  \begin{itemize}
    \item Location parameter: $(\mu_{0,i,j}^\star)^\true=-1 + \epsilon_{0,i,j}$, $\epsilon_{0,i,j} \sim \Uniform(-0.3, 0.3)$
    \item Location parameter: $(\mu_{1,i,j}^\star)^\true=1 + \epsilon_{1,i,j}$, $\epsilon_{1,i,j} \sim \Uniform(-0.3, 0.3)$
